...
<div class="container-fluid row">
    <div id="Information" class="col-md-6 mt-4">
    ...
    <div id="AuthForms" class="col-md-6">
        ...
        <div id="registerFormContainer" style="display: none;">
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="form-group">
                    <label for="password" class="form-label mt-4">Password</label>
                    <input id="password-register" type="text" class="form-control" name="password" value="{{ old('password') }}" aria-describedby="passwordHelp" placeholder="Enter password" required>
                    <small id="passwordHelp" class="form-text text-muted">Must be bigger then 8 characters.</small>

                </div>
                <!-- Confirm Password -->
                <div class="form-group">
                    <label for="password-confirm" class="form-label mt-4">Password</label>
                    <input id="password-confirm" type="text" class="form-control" name="password-confirm" value="{{ old('password') }}" placeholder="Enter password confirmation" required>
                </div>
