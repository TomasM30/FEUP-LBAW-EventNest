...
<div class="col mt-3 justify-content-center">
    ...
    <div class="col-12 col-md-9 mt-3 mx-auto">
        ...
        <div class="tab-content" id="v-pills-tabContent">
            <div class="tab-pane fade" id="v-pills-joined">
                <div class="row row-cols-1 row-cols-md-3 g-4 custom-row" id="container">
        ...
        <div class="tab-content" id="v-pills-tabContent">
            <div class="tab-pane fade" id="v-pills-favorite">
                <div class="row row-cols-1 row-cols-md-3 g-4 custom-row" id="container">
        ...
        <div class="tab-content" id="v-pills-tabContent">
            <div class="tab-pane fade" id="v-pills-attended">
                <div class="row row-cols-1 row-cols-md-3 g-4 custom-row" id="container">
